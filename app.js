...
console.log(createNewTaskElement(taskInput.value));
...
const editTask = function () {
    ...
    const containsClass = listItem.classList.contains("tasks__edit");
    //If class of the parent is .tasks__edit
    if(containsClass) {
        //switch to .tasks__edit
    ...
    //toggle .tasks__edit on the parent.
...
const deleteTask = function () {
    ...
    const listItem = this.parentNode;
    const ulItem = listItem.parentNode;
